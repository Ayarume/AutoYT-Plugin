...
public class JSONObject {
   ...
   public <E extends Enum<E>> E optEnum(Class<E> clazz, String key) {
      return (E) this.optEnum(clazz, key, (E) null);
   }

   public <E extends Enum<E>> Enum optEnum(Class<E> clazz, String key, E defaultValue) {
      try {
   ...
   public Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
      try {
         ...
         if (length == 1) {
            ...
            for(Iterator var8 = this.entrySet().iterator(); var8.hasNext(); commanate = true) {
               Entry<String, ?> entry = (Entry)var8.next();
               if (commanate) {
                  writer.write(44);
               }
   ...
   public Map<String, Object> toMap() {
      ...
      Entry entry;
      Object value;
      for(Iterator var3 = this.entrySet().iterator(); var3.hasNext(); results.put((String)entry.getKey(), value)) {
