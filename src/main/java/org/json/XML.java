...
public class XML {
   ...
   public static String escape(String string) {
      ...
      Iterator var3 = codePointIterator(string).iterator();
   ...
   public static Object stringToValue(String string) {
      ...
      return ret instanceof String ? unescape((String)ret) : ret;
   }
   ...
   public static String toString(Object object, String tagName) throws JSONException {
      ...
      if (object instanceof JSONObject) {
         ...
         var7 = jo.entrySet().iterator();

         while(true) {
            while(true) {
               while(var7.hasNext()) {
                  Entry<String, ?> entry = (Entry)var7.next();
                  ...
                  if ("content".equals(key)) {
                     if (value instanceof JSONArray) {
                        ...
                        for(Iterator var12 = ja.iterator(); var12.hasNext(); ++i) {
                           Object val = var12.next();
                           if (i > 0) {
                              sb.append('\n');
                           }
                     ...
                     ja = (JSONArray)value;
                     Iterator var11 = ja.iterator();

                     while(var11.hasNext()) {
                        Object val = var11.next();
